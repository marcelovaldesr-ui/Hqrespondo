...
export const BATTLECARDS: Battlecard[] = [
  {
    ...
    donde_diferenciarnos:
      "Precio de entrada mucho menor con implementación INCLUIDA hecha por nosotros; acompañamiento real post-venta. Estamos en el 'medio justo' para una pyme chilena (desde $149.990/mes neto, con instalación incluida y 14 días de prueba).",
    no_copiar:
    ...
    respuesta_comercial:
      "Buenas plataformas. Vambe apunta a empresas más grandes: su plan de entrada está sobre los $380.000 + ~$570.000 de implementación aparte. Nosotros damos las mismas 3.000 conversaciones que su plan Advanced (~$545.000) por $269.990 netos, con la IA incluida, en español, sin cobrar implementación y con acompañamiento real después de vender.",
