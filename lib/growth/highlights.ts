...
export const DESTACADAS: HighlightPlan[] = [
  ...
  },
  {
    ...
    historias: [
      ...
      { texto: "Inicial $149.990/mes neto · 1.200 conversaciones", visual: "Card de plan" },
      { texto: "Crecimiento $269.990/mes neto · 3.000 conversaciones — el más elegido", visual: "Card destacada" },
      { texto: "Empresa $449.990/mes neto · 6.000 conversaciones", visual: "Card de plan" },
  ...
  },
  {
    ...
    historias: [
      ...
      { texto: "¿Cuánto cuesta? Planes desde $149.990/mes neto, instalación incluida", visual: "Precio ancla" },
