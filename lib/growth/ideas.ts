...
export const CARRUSELES: CarouselDraft[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { rol: "desarrollo", texto: "Un asistente que no duerme ni pide vacaciones: desde $149.990 neto", nota_visual: "Cifra contraste" },
  ...
  },
  {
    ...
    slides: [
      ...
      { rol: "desarrollo", texto: "Inicial $149.990 · Crecimiento $269.990 · Empresa $449.990 (netos, instalación incluida)", nota_visual: "Tabla clara" },
