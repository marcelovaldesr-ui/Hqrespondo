...
export const IDEAS_SEED: ContentIdea[] = [
  ...
  // Venta / Oferta
  idea("Buscamos 5 clientes fundadores (cupos)", "venta", "reel", "instagram", "decision", { prioridad: "alta", fuente: "Piloto Fundador" }),
...
export const CARRUSELES: CarouselDraft[] = [
  ...
  },
  {
    ...
    slides: [
      ...
      { rol: "desarrollo", texto: "Un asistente que no duerme ni pide vacaciones: desde $79.000", nota_visual: "Cifra contraste" },
  ...
  },
  {
    ...
    slides: [
      ...
      { rol: "cierre", texto: "Quedan cupos del Piloto Fundador. Agenda 20 minutos 👇", nota_visual: "CTA + urgencia" },
    ],
    caption:
      "No configuras nada. Tú nos pasas tu info, nosotros lo dejamos andando esta semana. Cupos del Piloto Fundador con descuento en la implementación. Agenda 👇",
  ...
  },
  {
    ...
    slides: [
      ...
      { rol: "desarrollo", texto: "Inicial desde $79.000 · Crecimiento desde $149.000 · Pro desde $279.000", nota_visual: "Tabla clara" },
...
export const GUIONES: VideoScript[] = [
  ...
  {
    id: "vid-007",
    titulo: "Buscamos 5 clientes fundadores (oferta)",
    tipo: "oferta",
    pilar: "venta",
    rubro: null,
    canal: "instagram",
    duracion: "20-25s",
    objetivo: "Generar postulaciones al Piloto Fundador.",
    funnel: "decision",
    nivel_venta: "directo",
    hook: "Estamos buscando a nuestros primeros 5 clientes.",
    escenas: [
      { escena: "Founders a cámara", texto_pantalla: "Piloto Fundador", voz: "Somos dos personas construyendo Respondo y buscamos 5 clientes fundadores." },
      { escena: "Beneficio en pantalla", texto_pantalla: "Hasta 30% en la implementación", voz: "Descuento en la implementación y trabajo directo con nosotros." },
      { escena: "Intercambio", texto_pantalla: "A cambio: tu testimonio", voz: "A cambio, solo te pedimos tu testimonio honesto cuando lo veas funcionando." },
      { escena: "Cupos", texto_pantalla: "Quedan pocos cupos", voz: "Quedan pocos cupos. Si vendes por WhatsApp, escríbenos." },
    ],
    cta: "Escríbenos 'Piloto Fundador'. Bio.",
    version_corta: "5 cupos, descuento en implementación, a cambio de tu testimonio. Escríbenos → bio.",
...
export const CALENDARIO: ContentCalendarItem[] = [
  ...
  cItem("2026-07-31", "Reel: Buscamos 5 clientes fundadores", "reel", "venta", { idea_id: "idea-044" }),
