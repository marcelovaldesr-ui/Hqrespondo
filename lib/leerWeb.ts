...
export async function textoDeLaWeb(web: string, maxMs = 12_000): Promise<string | null> {
  ...
  // dato.
  if (/facebook\.com|instagram\.com|linktr\.ee|wa\.me\/|tiktok\.com|youtube\.com|x\.com|twitter\.com|ubereats\.com|rappi\.|pedidosya\.|justo\.mx|menu\.dine/i.test(web)) return null;
